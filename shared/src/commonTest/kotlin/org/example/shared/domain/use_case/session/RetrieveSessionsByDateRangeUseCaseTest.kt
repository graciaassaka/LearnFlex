...
class RetrieveSessionsByDateRangeUseCaseTest {
    private lateinit var useCase: RetrieveSessionsByDateRangeUseCase
    private lateinit var repository: SessionRepository

    @Before
    fun setUp() {
        repository = mockk()
        useCase = RetrieveSessionsByDateRangeUseCase(repository)
    }
