...
class GetModulesByCurriculumIdUseCaseTest {
    private lateinit var repository: ModuleRepository
    private lateinit var useCase: GetModulesByCurriculumIdUseCase

    @BeforeTest
    fun setUp() {
        repository = mockk()
        useCase = GetModulesByCurriculumIdUseCase(repository)
    }
