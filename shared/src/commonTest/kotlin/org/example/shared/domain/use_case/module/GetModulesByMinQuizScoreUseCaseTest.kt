...
class GetModulesByMinQuizScoreUseCaseTest {
    private lateinit var useCase: GetModulesByMinQuizScoreUseCase
    private lateinit var repository: ModuleRepository

    @Before
    fun setUp() {
        repository = mockk()
        useCase = GetModulesByMinQuizScoreUseCase(repository)
    }
