...
class GetLessonsByCurriculumIdUseCaseTest {
    private lateinit var repository: LessonRepository
    private lateinit var useCase: GetLessonsByCurriculumIdUseCase

    @BeforeTest
    fun setUp() {
        repository = mockk()
        useCase = GetLessonsByCurriculumIdUseCase(repository)
    }
