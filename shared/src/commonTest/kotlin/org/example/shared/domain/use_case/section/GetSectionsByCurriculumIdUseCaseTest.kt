...
class GetSectionsByCurriculumIdUseCaseTest {
    private lateinit var repository: SectionRepository
    private lateinit var useCase: GetSectionsByCurriculumIdUseCase

    @BeforeTest
    fun setUp() {
        repository = mockk()
        useCase = GetSectionsByCurriculumIdUseCase(repository)
    }
