...
class RetrieveSectionByMinQuizScoreUseCaseTest {
    private lateinit var useCase: RetrieveSectionByMinQuizScoreUseCase
    private lateinit var repository: SectionRepository

    @Before
    fun setUp() {
        repository = mockk()
        useCase = RetrieveSectionByMinQuizScoreUseCase(repository)
    }
