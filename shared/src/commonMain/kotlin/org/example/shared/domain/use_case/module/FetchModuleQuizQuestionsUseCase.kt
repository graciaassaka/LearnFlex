...
/**
 * Use case for generating a quiz for a module.
 *
 * @property generateQuizUseCase The use case responsible for generating quizzes.
 */
class FetchModuleQuizQuestionsUseCase(
    private val generateQuizUseCase: GenerateQuizUseCase
) {
    /**
     * Invokes the use case to generate a quiz for a module based on the given topic and level.
     *
     * @param topic The topic of the module for which the quiz is generated.
    ...
    companion object {
        const val NUMBER_OF_QUESTIONS = 8
    }
}