package org.example.learnflex.screen
...
class AuthScreenTest
{
    ...
    fun signInForm_signInWhenEmailAndPasswordAreValid()
    {
        ...
        // Then
        verify { viewModel.onExitAnimationFinished() }
            ...
            uiState.update {
                when (confirmPasswordValidationResult)
                {
                    ...
                    is ValidationResult.Invalid ->
                        it.copy(signUpPasswordConfirmation = confirmPassword, signUpPasswordConfirmationError = confirmPasswordValidationResult.message)
                }
            }
        }
